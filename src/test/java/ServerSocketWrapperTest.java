...
public class ServerSocketWrapperTest {
    ...
    @Test
    public void increaseHighTemperatureValue() throws UnknownHostException, IOException, InterruptedException {
    ...
    @Test
    public void decreaseLowTemperatureValue() throws UnknownHostException, IOException, InterruptedException {
    	HVAC hvac = new HVACMock();
    	Function<String, String> router = command -> {
    		CommandParser parser = new CommandParser(hvac);
    		return parser.parse(command) + "\n";
